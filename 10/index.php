...
<head>
    ...
    <title>Laboratorio 2 problema 10</title>
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container-sm">
                <br>
                <h1>Laboratorio 2 problema 10</h1>
                <br>
                <p> Escriba un programa donde se ingrese el tiempo necesario para un cierto proceso en 
...
<div class="container">
        ...
        <form class="form-inline" action="#" method="post" >
            <label for="content">Ingrese la duracion de la sesion:</label>
            <br><br>
            <label for="content">Horas: </label>
            <input type = "number" step="any"  name = "N1" placeholder = " " required >
            <label for="content">Minutos: </label>
            <input type = "number" step="any"  name = "N2" placeholder = " " required >
            <label for="content">Segundos: </label>
...
<?php
        ...
        $suma="";
            ...
            $horas=(int)$_POST['N1'];
            $minutos=(int)$_POST['N2'];
            $segundos=(int)$_POST['N3'];
        ...
        <table class="table">
            ...
            <thead>
                <tr>
                    ...
                    <th scope="col">costoXminutos</th>
                    <th scope="col">Conver a Seg</th>
                    <th scope="col">Total</th>
                </tr> 
            </thead>
            <tbody action = "#" method = "get">
                <tr>
                    <th scope="row"> <?php echo "$horas : $minutos : $segundos" ?></th>
                    <td>0.25</td>
                    <td> <?php echo "$suma" ?></td>
