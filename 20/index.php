...
<head>
    ...
    <title>Laboratorio 2 Problema 20</title>
</head>
<body>
...
<div class="container-sm">
                <br>
                <h1>Laboratorio 2 problema 20</h1>
                <br>
                <p> Crear un archivo que con valores generados al azar con 10 filas por la función rand() de php.                 </p>
        </div>
        ...
        <?php for ($i=0; $i<=10; $i++){ 
            ...
            <tr>
                ...
                <td><div class="progress">
                    <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated" role="progressbar" style="width: <?php echo $num ?>%;" aria-valuenow="<?php echo $num ?>" aria-valuemin="0" aria-valuemax="100"><?php echo $num ?>%</div>
                </div></td>
            <?php } ?>  
        </tbody>
    </table>
