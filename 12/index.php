...
<head>
    ...
    <title>Laboratorio 2 problema 12</title>
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="container-sm">
                <br>
                <h1>Laboratorio 2 problema 12</h1>
                <br>
                <p> Elabore un programa que realice la conversión de libras a kilogramos 
                    <br> Donde 1 Kg. = 2.2046 libras.
                </p>
        </div>
    ...
    <div class="container">
        ...
        <form class="form-inline" action="#" method="post" >
            ...
            <br><br>
            <label for="content"> Libras: </label>
    ...
    <div class="container-sm">
        <table class="table">
            ...
            <tbody action = "#" method = "get">
                <tr>
                    <th scope="row"> <?php echo "$lb Lb"?></th>
                    <td> <?php echo "$result kg" ?></td>
                </tr>
